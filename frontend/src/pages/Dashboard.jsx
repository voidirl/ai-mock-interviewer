...
const Topics = ["Arrays", "Linked Lists", "Trees",
    "Graphs", "System Design", "SQL",
    "OOP", "Dynamic Programming", "DBMS", "OS Concepts"];
    ...
    return (
        <div style={{ minHeight: "100vh", background: "#0f1117", color: "#e2e8f0", fontFamily: "'Inter', sans-serif" }}>
            ...
            <nav style={{
                ...
                padding: "1rem 2rem", borderBottom: "1px solid #1e2533", background: "#0f1117",
            }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    <span style={{ fontWeight: 600, fontSize: 16, letterSpacing: "-0.3px" }}>MockForge</span>
                </div>
            ...
            <div style={{ maxWidth: 860, margin: "0 auto", padding: "3rem 1.5rem" }}>
                ...
                <div style={{ marginBottom: "2.5rem" }}>
                    ...
                    <p style={{ color: "#64748b", marginTop: 6, fontSize: 15 }}>
                        Configure your session and start the interview.
                    </p>
                </div>
                ...
                <div style={{
                    ...
                    borderRadius: 14, padding: "2rem", marginBottom: "2rem",
                }}>
                    <h2 style={{
                        ...
                        <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                            {TOPICS.map(t => (
                                <button key={t} onClick={() => setTopic(t)} style={{
                                    ...
                                    border: topic === t ? "1px solid #00d2a0" : "1px solid #2d3748",
                                    background: topic === t ? "rgba(0,210,160,0.1)" : "transparent",
                                    color: topic === t ? "#00d2a0" : "#94a3b8",
                                    cursor: "pointer",
                                }}>{t}</button>
                            ))}
                        </div>
                            ...
                            {DIFFICULTIES.map(d => {
                                ...
                                return (
                                    <button key={d} onClick={() => setDifficulty(d)} style={{
                                        ...
                                        border: active ? `1px solid ${c.border}` : "1px solid #2d3748",
                    ...
                    <div>
                        ...
                        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                            {TYPES.map(type => (
                                <button key={type} onClick={() => setQuestionType(type)} style={{
                                    padding: "7px 18px", borderRadius: 8, fontSize: 13,
                                    border: questionType === type ? "1px solid #0ea5e9" : "1px solid #2d3748",
                                    background: questionType === type ? "rgba(14,165,233,0.1)" : "transparent",
                                    color: questionType === type ? "#0ea5e9" : "#94a3b8",
                                    cursor: "pointer",
